		         ...
		         <div className="row justify-content-center">
		              ...
		              <div className="row align-items-center justify-content-center no-gutters mb-4">
		                <div className="col-auto">
		                  <div className="avatar mr-3">
		                    <img src="https://simpleqode.bitbucket.io/incline/assets/img/56.jpg" alt="..." className="img-cover rounded-circle" />
		                  </div>
		                </div>
		                <div className="col-auto">
		                  <p className="mb-0 text-xs text-muted">
		                    by <strong className="text-body">Judy Doe</strong> 2 hours ago
		                  </p>
		                </div>
		              </div>
		          ...
		          <div className="row">
		            <div className="col-12">
		              <img src="https://simpleqode.bitbucket.io/incline/assets/img/56.jpg" alt="..." className="img-fluid mb-3" />
